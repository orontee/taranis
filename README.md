...
The application can consume an
[OpenWeather](https://openweathermap.org) service called One Call API.
An API key is distributed with the application; But users can use
...
on this topic in the [translations documentation](./po/README.md).
